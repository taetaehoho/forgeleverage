...
if (process.env.NETWORK == "421613") {
    ...
    UNISWAP_V3_ROUTER_ADDRESS = UNISWAP_ADDRESS.polygon.UNISWAP_V3_ROUTER_ADDRESS!;
    USDC_TOKEN_ADDRESS = UNISWAP_ADDRESS.polygon.USDC_TOKEN_ADDRESS!;
    WETH_ADDRESS = UNISWAP_ADDRESS.polygon.WETH_ADDRESS!;
} else if (process.env.NETWORK == "8453") { // base
    RPC_URL = process.env.BASE_RPC_URL!;
    UNISWAP_V3_ROUTER_ADDRESS = UNISWAP_ADDRESS.base.UNISWAP_V3_ROUTER_ADDRESS!;
    USDC_TOKEN_ADDRESS = UNISWAP_ADDRESS.base.USDC_TOKEN_ADDRESS!;
    WETH_ADDRESS = UNISWAP_ADDRESS.base.WETH_ADDRESS!;
} else if (process.env.NETWORK == "42220") { // celo
    RPC_URL = process.env.CELO_RPC_URL!;
    UNISWAP_V3_ROUTER_ADDRESS = UNISWAP_ADDRESS.celo.UNISWAP_V3_ROUTER_ADDRESS!;
    USDC_TOKEN_ADDRESS = UNISWAP_ADDRESS.celo.USDC_TOKEN_ADDRESS!;
    WETH_ADDRESS = UNISWAP_ADDRESS.celo.WETH_ADDRESS!;
}
